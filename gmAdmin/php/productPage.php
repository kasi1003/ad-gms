...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!isset($_SESSION['form_submitted'])) {
        ...
        if (isset($_POST['productName'], $_POST['productDescription'], $_POST['price'])) {
            ...
            $sql = "INSERT INTO products (productName, productDescription, price) VALUES ('$productName', '$productDescription', '$price')";
...
?>
    ...
    $sql = "SELECT productName, productDescription, price FROM products";
